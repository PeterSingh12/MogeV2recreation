# my_moge ONNX Support

my_moge-2 is compatible with the ONNX format (opset version ≥ 14). We have exported several models for use in ONNXRuntime or deployment on other compatible inference engines.
...
<table>
  ...
  <tbody>
    <tr>
     <td rowspan="3">my_moge-2</td>
      <td><a href="https://huggingface.co/Ruicheng/my_moge-2-vitl-normal-onnx" target="_blank"><code>Ruicheng/my_moge-2-vitl-normal-onnx</code></a></td>
    </tr>
    <tr>
      <td><a href="https://huggingface.co/Ruicheng/my_moge-2-vitb-normal-onnx" target="_blank"><code>Ruicheng/my_moge-2-vitb-normal-onnx</code></a></td>
    </tr>
    <tr>
      <td><a href="https://huggingface.co/Ruicheng/my_moge-2-vits-normal-onnx" target="_blank"><code>Ruicheng/my_moge-2-vits-normal-onnx</code></a></td>
    </tr>
  </tbody>
</table>
...
import numpy as np
import torch
from my_moge.model.v2 import my_mogeModel

PRETRAINED_MODEL = 'Ruicheng/my_moge-2-vits-normal.pt'
ONNX_FILE = 'my_moge-2-vits-normal.onnx'

model = my_mogeModel.from_pretrained(PRETRAINED_MODEL)
...
class my_mogeStatic(my_mogeModel):
...
model = my_mogeStatic.from_pretrained(PRETRAINED_MODEL)
model.onnx_compatible_mode = True  # Enable ONNX compatible mode
